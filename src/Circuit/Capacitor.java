...
/** LED Class
 * A Capacitor CircuitPart that can be used in the circuit
...
public class Capacitor extends CircuitPart
{
    ...
    private int picoFerets; //the amount of picoferets of the capacitor
    
    /**Constructor for the Capacitor object. Assigns the object its corresponding
     * name and picoferets value.
     * @param n     The name of the object
     * @param f     The amount of picoferets of the capacitor
     */ 
    public Capacitor(String n, int f)
    {
        super(n);
        picoFerets = f;
    }   
    ...
    /**Accessor method for the picoferet value of this capacitor.
     * @return the picoferet value of this capacitor
     */
    public int getPicoFerets()
    {
        return picoFerets;
    }
