...
/** Diode Class
 * A Diode CircuitPart that can be used in the circuit
...
public class Diode extends CircuitPart
{
    ...
    /**Constructor for the Diode object. Assigns the object its corresponding
     * name.
     * @param n     The name of the object
     */ 
    public Diode(String n)
    {
        super(n);
    }
