...
/** LED Class
 * An LED CircuitPart that can be used in the circuit
...
public class LED extends CircuitPart
{
    private boolean powerS2;    //Positive power of side 2
    private boolean negPowerS2; //Negative power of side 2
  
    public static final int RED = 1;         //Integers for the corresponding colours
    ...
    private int colour;   //Colour of the object
    
    /**Constructor for the LED object. Assigns the object its corresponding
     * name and colour.
     * @param n     The name of the object
     * @param color The colour of the LED
     */ 
    public LED(String n, int color)
    {
        super(n);
        colour = color;
    }
    ...
    /**Accessor method to get the LED's colour.
