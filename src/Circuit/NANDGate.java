...
/** NANDGate Class
 * A NAND gate CircuitPart that can be used in the circuit
...
public class NANDGate extends CircuitPart
{
    ...
    /**Constructor for the NANDGate CircuitPart. Assigns the object its corresponding
     * name.
