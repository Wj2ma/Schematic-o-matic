...
/** NORGate Class
 * A NOR gate CircuitPart that can be used in the circuit
...
public class NORGate extends CircuitPart
{
    ...
    /**Constructor for the NORGate CircuitPart. Assigns the object its corresponding
     * name.
