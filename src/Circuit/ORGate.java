...
/** ORGate Class
 * An OR gate CircuitPart that can be used in the circuit
...
public class ORGate extends CircuitPart
{
    ...
    /**Constructor for the ORGate CircuitPart. Assigns the object its corresponding
     * name.
     * @param n     The name of the object
     */ 
    public ORGate(String n)
    {
        super(n);
    }   
