...
/** Resistor Class
 * A Resistor CircuitPart that can be used in the circuit
...
public class Resistor extends CircuitPart
{
    ...
    private int resistance; //the amount of resistance of the resistor
    
    /**Constructor for the Resistor object. Assigns the object its corresponding
     * name and resistance value.
     * @param n     The name of the object
     * @param ohms     The amount of resistance for the resistor
     */ 
    public Resistor(String n, int ohms)
    {
        super(n);
        resistance = ohms;
    }    
    ...
    /**Accessor method for the resistance value of this resistor.
     * @return the resistance value of this resistor
     */
