...
/** Switch Class
 * A Switch CircuitPart that can be used in the circuit
...
public class Switch extends CircuitPart
{
    ...
    private boolean negSwitch = false;
    private boolean posSwitch = false;
    
    /**Constructor for the Switch object. Assigns the object its corresponding
     * name.
     * @param n     The name of the object
     */ 
    public Switch(String n, int type)
    {
        super(n);
    ...
    public void resetPower()
    {
        ...
        powerS1 = false;
        negPowerS1 = false;
        if (!posSwitch)         //if this switch is a positive switch, keep side 2 power as true
            powerS2 = false;
        if (!negSwitch)         //if this switch is a negative switch, keep side 2 negpower as true
            negPowerS2 = false;
    }
    ...
    /**Mutator method to either turn on or turn off the switch.
     * @param s     True for on and false for off
     */
    ...
    /** Returns a true or false if this is a positive switch
     * @return posSwitch
     */
    public boolean isPositiveSwitch()
    {
        return posSwitch;
    }
}
