...
/** XORGate Class
 * A XOR gate CircuitPart that can be used in the circuit
...
public class XORGate extends CircuitPart
{
    ...
    /**Constructor for the XORGate CircuitPart. Assigns the object its corresponding
     * name.
     * @param n     The name of the object
     */ 
    public XORGate(String n)
    {
        super(n);
    }   
